...
public class SwerveModule {
    ...
    public double getTurningPosition() {
        return Math.IEEEremainder(turningEncoder.getPosition(), 2 * Math.PI);
    }
    ...
    public void setDesiredState(SwerveModuleState state) {
        ...
        turningMotor.set(turningPidController.calculate(getTurningPosition(), MathUtil.angleModulus(state.angle.getRadians())));
